...
/**
 * 旧ブログの記事。times サービス化に伴い読み取り専用のアーカイブになった。
 * /posts/:slug で静的に配信し続けるためだけに残している。
 */
#[ORM\Entity(repositoryClass: ArchivedPostRepository::class)]
#[ORM\Table(name: 'archived_posts')]
#[ORM\Index(name: 'idx_archived_posts_published', columns: ['status', 'published_at'])]
...
class ArchivedPost
{
    ...
    #[ORM\JoinTable(name: 'archived_post_tags')]
