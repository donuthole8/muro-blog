/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 24179c4398c45ad9550a8c8c81733ffa)
// Runtime types generated with workerd@1.20260903.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	BLOG_IMAGES: KVNamespace;
	API_BASE_URL: string;
	SITE_URL: string;
	ADMIN_TOKEN: string;
	API: Fetcher /* teatimes-api */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_BASE_URL" | "SITE_URL" | "ADMIN_TOKEN">> {}
}
