 ...
 * 未読がある部屋は太字にして件数を出す。狭い画面ではヘッダーの「フォロー中」から辿る。
 */
export function Sidebar() {
  ...
  return (
    <aside className="sticky top-[3.75rem] hidden h-[calc(100dvh-3.75rem)] w-60 shrink-0 overflow-y-auto border-r border-border px-3 py-6 lg:block">
...
const itemClass =
  'flex min-h-8 items-center gap-1.5 rounded-md px-2 text-text-muted transition-colors hover:bg-accent-soft hover:text-text'
